        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4, notification_1.default
                        ...
                        var _a;
                        res.json({
                            notifications: __assign(__assign({}, notifications), { notifications: lodash_1.sortBy((_a = notifications === null || notifications === void 0 ? void 0 : notifications.notifications) !== null && _a !== void 0 ? _a : [], {
                                    time: -1,
                                }) }),
                        });
                    })
...
notificationRoute.put("/mark-read", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var auth, token, decoded, found, error_2;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
